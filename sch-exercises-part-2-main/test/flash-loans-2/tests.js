...
describe("Flash Loans Exercise 2", function () {
  ...
  it("AAVE V3 Flash Loan", async function () {
    ...
    const flashLoan = await FlashLoanReceiver.deploy(AAVE_LENDING_POOL_ADDRESS);
    // TODO: Send USDC to contract for fees
    await usdc
      .connect(impersonatedSigner)
      .transfer(flashLoan.address, FEE_AMOUNT);
    // TODO: Execute successfully a Flash Loan of $100,000,000 (USDC)
    await flashLoan.getFlashLoan(usdc.address, BORROW_AMOUNT);
  });
});
