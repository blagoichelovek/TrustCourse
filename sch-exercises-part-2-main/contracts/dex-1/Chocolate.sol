...
contract Chocolate is ERC20, Ownable {
    ...
    constructor(uint256 _initialMint) ERC20("Chocolate Token", "Choc") {
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address weth) external returns (address pair){
        };
    ...
    */
    function swapChocolates(address _tokenIn, uint256 _amountIn) public payable {
        ...
        if(_tokenIn == address(this)) {
            ...
            require(msg.value == 0, "U shouldn't sent ETH for chocolate swap");
            ...
            _approve(msg.sender, address(uniswapV2Router), _amountIn);
