...
contract RainbowAllianceToken is ERC20, Ownable {
    ...
    // @audit-issue
    // Voting system isn't correct because if user1 transfer his votingPower
    // to user2 then user2 can't call createProposal function
    // Built-in ERC20 functions like Transfer and Transferfrom don't work
